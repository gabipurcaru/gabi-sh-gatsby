  ...
  return (
    <Layout>
      ...
      <p className="leading-relaxed text-2xl md:px-16 -mb-8 text-center">
        ...
        Currently, I&apos;m fighting fake accounts and platform abuse on Facebook and Instagram.
        Here&apos;s a bit about me.</p>
        ...
        <div className="-my-8">
          <div className="py-8 flex flex-wrap md:flex-no-wrap">
            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
              <span className="tracking-widest font-medium title-font text-gray-900">Facebook London</span>
              <span className="mt-1 text-gray-500 text-sm">March 2017 &ndash; today</span>
            </div>
            <div className="md:flex-grow">
              <h2 className="text-2xl font-medium text-gray-900 title-font mb-2">Software Engineer</h2>
              <p className="leading-relaxed">
                I&apos;ve revolved around the human review, security, and integrity/platform abuse spaces.
                Along with excellent colleagues, I&apos;ve created a SQL-like DSL for online/offline security event analysis,
                aligned Instagram&apos;s account-level abuse detection with the Facebook equivalent.
                I&apos;ve led my organisation in implementing emerging data use regulations on a tight deadline,
                and helped define the future paradigm of human review.</p>
            </div>
          </div>
          <div className="py-8 flex border-t-2 border-gray-200 flex-wrap md:flex-no-wrap">
            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
              <span className="tracking-widest font-medium title-font text-gray-900">Facebook London</span>
              <span className="mt-1 text-gray-500 text-sm">September &ndash; November 2016</span>
            </div>
            <div className="md:flex-grow">
              <h2 className="text-2xl font-medium text-gray-900 title-font mb-2">Software Engineer Intern</h2>
              <p className="leading-relaxed">I&apos;ve helped improve Facebook&apos;s machine learning dataset labeling platform.</p>
            </div>
          </div>
          <div className="py-8 flex border-t-2 border-gray-200 flex-wrap md:flex-no-wrap">
            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
              <span className="tracking-widest font-medium title-font text-gray-900">Facebook London</span>
              <span className="mt-1 text-gray-500 text-sm">September &ndash; November 2015</span>
            </div>
            <div className="md:flex-grow">
              <h2 className="text-2xl font-medium text-gray-900 title-font mb-2">Software Engineer Intern</h2>
